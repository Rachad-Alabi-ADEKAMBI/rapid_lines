...
<div class="main">
          ...
          <div class="pad">
            <div class="wrapper pad_bot1">
              <p class="cols pad_bot2"><strong>Country:<br>
                ...
                Address:<br>
                Email:</strong></p>
              <p class="color1 pad_bot2">Philipines<br>
                Quezon City, Metro Manila<br>
                1101 Matandang Balara<br>
                <a href="#">rapid_lines@mail.com</a></p>
            </div>
          </div>
        </div>
      </article>
  ...
  <footer>
    <div class="wrapper">
      ...
      <div class="links">Copyright &copy; <a href="#">Rapid lines</a> All Rights Reserved<br>
      <!--  Made by <a target="_blank" href="http://www.templatemonster.com/">TemplateMonster.com</a></div>-->
      Made by
